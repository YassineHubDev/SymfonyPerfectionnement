 ...
 */
final class Version20190627090633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(128) NOT NULL, description LONGTEXT NOT NULL, price NUMERIC(9, 2) NOT NULL, nb_views INT NOT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME NOT NULL, etat_publication TINYINT(1) NOT NULL, image_name VARCHAR(128) NOT NULL, slug VARCHAR(128) NOT NULL, UNIQUE INDEX UNIQ_D34A04AD989D9B62 (slug), INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
